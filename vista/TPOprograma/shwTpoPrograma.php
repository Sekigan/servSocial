  ...
  <table class="table  table-striped  table-hover" id="tabla" border="0">
      <thead>
          <tr>
            ...
            <th style="width:8%; background-color: #5DACCD; color:#fff">idDependencia</th>
      ...
      <?php foreach($this->modelo->Listar() as $r): ?>
          <tr>
            ...
            <td>
                ...
                onclick="javascript:return confirm('¿Seguro de eliminar el registro <?php echo $r->nombre.' '.$r->id; ?>?');"
                href="?c=TPOprograma&a=Eliminar&id=<?php echo $r->id; ?>">Eliminar</a>
            </td>
          </tr>
      <?php endforeach; ?>
      </tbody>
