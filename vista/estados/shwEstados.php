<div class="container-fluid box">
    <div id='encabezado' style="padding:0px;">
        <h3>Mostrando Registros de estado</h3>
        <ol class="breadcrumb">
            <li>Sistema Informático - Servicio Social ITSaltillo</li>
            <li><a href="?c=estado&a=Crud&gui=estado">Agregar</a></li>
        ...
        <tbody>
            <?php foreach ($this->modelo->Listar() as $r) : ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-warning" href="?c=estado&a=Crud&gui=estado&id=<?php echo $r->id; ?>">Editar</a>
                    </td>
                    <td>
                        <a class="btn btn-danger" onclick="javascript:return confirm('¿Seguro de eliminar el registro <?php echo $r->clave . ' ' . $r->nombre; ?>?');" href="?c=estado&a=Eliminar&id=<?php echo $r->id; ?>">Eliminar</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
